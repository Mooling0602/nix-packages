...
| [`niri-input-portal`](pkgs/by-name/ni/niri-input-portal/README.md) | 面向 niri 的 xdg-desktop-portal InputCapture 后端，让 Deskflow 这类键鼠共享软件能把本机键鼠与剪贴板推到另一台电脑；从上游源码构建，附带一个本地补丁（MIT，Linux） |
